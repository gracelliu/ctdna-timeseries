...
create_patient_plot <- function(patient_id) {
  ...
  label_gtv <- ggdraw() + draw_label("GTV", x = 0.5, y = 0.5, angle = 90, hjust = 0.5, vjust = 0.5, size = 25, fontface = "bold")
  label_fate <- ggdraw() + draw_label("FATE", x = 0.5, y = 0.5, angle = 90, hjust = 0.5, vjust = 0.5, size = 25, fontface = "bold")
  label_ctdna <- ggdraw() + draw_label("ctDNA", x = 0.5, y = 0.5, angle = 90, hjust = 0.5, vjust = 0.5, size = 25, fontface = "bold")
...
#   ggsave(filename = plot_filename, plot = all_patient_plots[[i]], width = 8, height = 10)
# }
