...
t_annotated <- annotate_figure(t_combined_plot, 
                               left = textGrob("Tumour Volume", rot = 90, vjust = 0.2, gp = gpar(cex = 1.3)),
...
ggsave("../results/tumor_volume_Tstage_plot.png", t_annotated, width = 7, height = 3)
ggsave("../results/tumor_volume_Nstage_plot.png", n_annotated, width = 7, height = 3)
...
# Save plot with specific dimensions
ggsave("../results/change_hpv_all.png", g, width = 6, height = 3)
