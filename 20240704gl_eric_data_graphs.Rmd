...
g1 <- ggplot(df_baseline, aes(x = stage_t_ajcc8, y = seq_copies_mL_log)) +
...
g2 <- ggplot(df_baseline, aes(x = stage_n_ajcc8, y = seq_copies_mL_log)) +
  geom_boxplot(fill="antiquewhite4") +
  labs(x = "Nodal Stage (N)",
       y = "HPV Sequence Copies (count per mL)") +
  stat_compare_means()

# Sequence copies by Overall Stage
g3 <- ggplot(df_baseline, aes(x = stage_ajcc8, y = seq_copies_mL_log)) +
  geom_boxplot(fill="antiquewhite4") +
  labs(x = "Overall Stage",
       y = "HPV Sequence Copies (count per mL)") +
  stat_compare_means()
...
combined_plot <- (g1 | g2 | g3) + 
  plot_layout(ncol = 3) +
  plot_annotation(title = "HPV Sequence Copies by different Stages (Baseline)")
...
# Sequence copies by T Stage 
g1 <- ggplot(df_early_rt, aes(x = stage_t_ajcc8, y = seq_copies_mL_log)) +
...
# Sequence copies by N Stage
g2 <- ggplot(df_early_rt, aes(x = stage_n_ajcc8, y = seq_copies_mL_log)) +
  geom_boxplot(fill="antiquewhite3") +
  labs(x = "Nodal Stage (N)",
       y = "HPV Sequence Copies (count per mL)") +
  stat_compare_means()
...
# Sequence copies by Overall Stage 
g3 <- ggplot(df_early_rt, aes(x = stage_ajcc8, y = seq_copies_mL_log)) +
  geom_boxplot(fill="antiquewhite3") +
  labs(x = "Overall Stage",
       y = "HPV Sequence Copies (count per mL)") +
  stat_compare_means()
...
combined_plot <- (g1 | g2 | g3) + 
  plot_layout(ncol = 3) +
  plot_annotation(title = "HPV Sequence Copies by different Stages (Early RT)")
...
# Sequence copies by T Stage 
g1 <- ggplot(df_mid_rt, aes(x = stage_t_ajcc8, y = seq_copies_mL_log)) +
...
# Sequence copies by N Stage 
g2 <- ggplot(df_mid_rt, aes(x = stage_n_ajcc8, y = seq_copies_mL_log)) +
  geom_boxplot(fill="antiquewhite2") +
  labs(x = "Nodal Stage (N)",
       y = "HPV Sequence Copies (count per mL)") +
  stat_compare_means()
...
#Sequence copies by Overall Stage 
g3 <- ggplot(df_mid_rt, aes(x = stage_ajcc8, y = seq_copies_mL_log)) +
  geom_boxplot(fill="antiquewhite2") +
  labs(x = "Overall Stage",
       y = "HPV Sequence Copies (count per mL)") +
  stat_compare_means()
...
combined_plot <- (g1 | g2 | g3) + 
  plot_layout(ncol = 3) +
  plot_annotation(title = "HPV Sequence Copies by different Stages (Mid RT)")
...
# Sequence copies by T Stage 
g1 <- ggplot(df_3_month, aes(x = stage_t_ajcc8, y = seq_copies_mL_log)) +
  geom_boxplot(fill="antiquewhite1") +
  labs(title = "HPV Sequence Copies by Tumor Stage (3 Months Post-RT)",
       x = "Tumor Stage (T)",
       y = "HPV Sequence Copies (count per mL)") +
  stat_compare_means()

# Sequence copies by N Stage 
g2 <- ggplot(df_3_month, aes(x = stage_n_ajcc8, y = seq_copies_mL_log)) +
  geom_boxplot(fill="antiquewhite1") +
  labs(title = "HPV Sequence Copies by Nodal Stage (3 Months Post-RT)",
       x = "Nodal Stage (N)",
       y = "HPV Sequence Copies (count per mL)") +
  stat_compare_means()

# Sequence copies by Overall Stage 
g3 <- ggplot(df_3_month, aes(x = stage_ajcc8, y = seq_copies_mL_log)) +
  geom_boxplot(fill="antiquewhite1") +
  labs(title = "HPV Sequence Copies by Overall Stage (3 Months Post-RT)",
       x = "Overall Stage",
       y = "HPV Sequence Copies (count per mL)") +
  stat_compare_means()
...
combined_plot <- (g1 | g2 | g3) + 
  plot_layout(ncol = 3) +
  plot_annotation(title = "HPV Sequence Copies by different Stages (3 Months Post-RT)")
